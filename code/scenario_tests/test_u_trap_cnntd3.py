...
TEST_CASES = [
    ...
    ([[7.5],[5.0],[0.0]],    [[9.0],[5.0],[0]]),   # 朝右，正对开口
    ([[7.5],[5.0],[1.57]],   [[9.0],[5.0],[0]]),   # 朝上，需要转向
    ([[7.5],[5.0],[3.14]],   [[9.0],[5.0],[0]]),   # 朝左（背对开口，最难）
    ([[7.5],[5.0],[-1.57]],  [[9.0],[5.0],[0]]),   # 朝下
    ([[7.5],[6.0],[0.0]],    [[9.0],[5.0],[0]]),   # 偏上起点
    ([[7.5],[4.0],[0.0]],    [[9.0],[5.0],[0]]),   # 偏下起点
    ([[7.0],[5.0],[3.14]],   [[9.0],[5.0],[0]]),   # 更靠里，背对开口
    ([[7.5],[5.5],[1.57]],   [[9.0],[5.0],[0]]),   # 目标偏下
    ([[7.5],[4.5],[-1.57]],  [[9.0],[5.0],[0]]),   # 目标偏上
    ([[7.0],[5.0],[2.0]],    [[9.0],[5.0],[0]]),   # 斜朝向
]
